...
CmdLine
	...
	.option('--properties [propsFile]', 'A JSON file containing Key-value pairs' )
	;
...
function checkIfSubProjectExists( _PROJNAME, _DIR_orgASUXSubProject, _DIR_orgASUXSubProject_Downloaded )
{
	...
	try {
			...
			try {
				EXECUTESHELLCMD.renameAndMove( _DIR_orgASUXSubProject_Downloaded, _DIR_orgASUXSubProject );
				...
				// fs.renameSync( ORGASUXHOME +'/'+ fileNewNameOnly, _DIR_orgASUXSubProject ); // destFldrPath );
